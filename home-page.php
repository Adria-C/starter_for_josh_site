...
<section class="container-fluid aboutbg text-center">
    <div class="container">
        <lottie-player id="twelfthLottie" src="http://170.187.231.66/~mesh7/wp-content/themes/starter_for_josh_site/images/rocketman.json" background="transparent" speed="1" style="margin:auto width: 200px; height: 200px" direction="1" ></lottie-player></a>
