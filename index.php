...
<section class="container-fluid aboutbg text-center">
    <div class="container">
        ...
        <p class="particle">.... and particals wizard</p>
...
<section class="container-fluid articlesbg">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
              <img class="img-fluid" src="http://170.187.231.66/~mesh7/wp-content/themes/starter_for_josh_site/images/port1.jpg" alt="woman">
            ...
            <div class="col-md-4">
              <img class="img-fluid" src="http://170.187.231.66/~mesh7/wp-content/themes/starter_for_josh_site/images/port2.jpg" alt="woman">
              <h4 class="article-title">A PORTRAIT</h4>
              <P class="date">Friday,November 10. 2030</P>
              <P class="article-p">STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.</P>
              <a class="readmore" href="#">CONTINUE READING </a>
            ...
            <div class="col-md-4">
              <img class="img-fluid" src="http://170.187.231.66/~mesh7/wp-content/themes/starter_for_josh_site/images/port3.jpg" alt="woman">
              <h4 class="article-title">A PORTRAIT</h4>
              <P class="date">Friday,November 10. 2030</P>
              <P class="article-p">STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.</P>
              <a class="readmore" href="#">CONTINUE READING </a>
